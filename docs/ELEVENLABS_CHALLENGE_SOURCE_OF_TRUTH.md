...
This file is the product authority for BenchBid. If another plan, feature, or demo choice conflicts with this brief, this file wins.
...
## BenchBid interpretation

BenchBid uses laboratory equipment repair as the chosen B2B vertical. The challenge concepts map as follows:
